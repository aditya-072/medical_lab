...
function Create({ query }) {
    ...
    const [EW, setEW] = useState("");               // string
    const [MV_AML, setMV_AML] = useState("");       // string
    const [MV_PML, setMV_PML] = useState("");       // string
    const [MV_D_E, setMV_D_E] = useState("");        // int
    const [MV_D_A, setMV_D_A] = useState("");        // int
    const [MV_D_DT, setMV_D_DT] = useState("");      // int
    const [MV_D_EA, setMV_D_EA] = useState("");     // int
    const [MV_DF, setMV_DF] = useState("");         // string
    const [MV_MS, setMV_MS] = useState("");         // string
    const [MV_MR, setMV_MR] = useState("");         // string
    const [MV_A4C_LAA, setMV_A4C_LAA] = useState("");   // int
    const [MV_A4C_JA, setMV_A4C_JA] = useState("");     // decimal
    const [TV_M, setTV_M] = useState("");               // string
    const [TV_TS, setTV_TS] = useState("");             // string
    const [TV_TR, setTV_TR] = useState("");             // string
    const [TV_RVSP, setTV_RVSP] = useState("");         // int
    const [TV_PH, setTV_PH] = useState("");             // string
    const [AV_M, setAV_M] = useState("");               // string
    const [AV_D_APSV, setAV_D_APSV] = useState("");     // decimal
    const [AV_AS, setAV_AS] = useState("");             // string
    const [AV_AR, setAV_AR] = useState("");             // string
    const [PV_M, setPV_M] = useState("");               // string
    const [PV_PS, setPV_PS] = useState("");             // string
    const [PV_PR, setPV_PR] = useState("");             // string
    const [IVsd, setIVsd] = useState("");               // decimal
    const [LVIDd, setLVIDd] = useState("");             // decimal
    const [LVPWd, setLVPWd] = useState("");             // decimal
    const [IVss, setIVss] = useState("");               // decimal
    const [LVIDs, setLVIDs] = useState("");             // decimal
    const [LVPWs, setLVPWs] = useState("");             // decimal
    const [EF, setEF] = useState("");                   // decimal
    const [Aorta, setAorta] = useState("");             // decimal
    const [LA, setLA] = useState("");                   // decimal
    const [RVIDd, setRVIDd] = useState("");             // decimal
    const [RVFW, setRVFW] = useState("");               // decimal
    const [FS, setFS] = useState("");                   // decimal
    const [TAPSE, setTAPSE] = useState("");             // decimal
    const [VEF, setVEF] = useState("");                 // string
    const [IVSM, setIVSM] = useState("");               // string
    const [C_LA, setC_LA] = useState("");               // string
    const [C_LV, setC_LV] = useState("");               // string
    const [C_RA, setC_RA] = useState("");               // string
    const [C_RV, setC_RV] = useState("");               // string
    const [RWMA, setRWMA] = useState("");               // string
    const [BASALLV, setBASALLV] = useState("");         // string
    const [MIDLV, setMIDLV] = useState("");             // string
    const [APICALLV, setAPICALLV] = useState("");       // string
    const [LVAPEX, setLVAPEX] = useState("");           // string
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const response = axios.put(`/api/patients/${query["id"]}`, { echoJson: data });
